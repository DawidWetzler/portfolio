<template>
  <svg
    v-bind="$attrs"
    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 396.62 500"
  >
    <defs>
      <style>.cls-1, .cls-2 {
        fill: #d6d8e5;
      ...
      <linearGradient
        id="Безымянный_градиент_15" x1="101.94" y1="197.18" x2="389.84" y2="197.18"
    ...
    <g id="Слой_2" data-name="Слой 2">
      <g id="Слой_1-2" data-name="Слой 1">
        ...
        <g id="Men_5">
              ...
              <g id="_Группа_6" data-name="&lt;Группа&gt;">
                <g id="_Группа_7" data-name="&lt;Группа&gt;">
                  <g id="_Группа_8" data-name="&lt;Группа&gt;">
                    <path
                      id="_Контур_8" data-name="&lt;Контур&gt;" class="cls-10"
          ...
          <path
            id="_Контур_16" data-name="&lt;Контур&gt;" class="cls-11"
          ...
          />
          <path
            id="_Контур_17" data-name="&lt;Контур&gt;" class="cls-8"
          ...
          />
          <path
            id="_Контур_18" data-name="&lt;Контур&gt;" class="cls-9"
...
@Component
export default class ComputerIcon extends Vue {
  //
}
</script>
